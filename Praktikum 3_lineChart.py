...
def trend_lines_plot():
    ...
    ax.plot(months, product_B_sales, label='Product B Trend',
            linestyle='-', color='red')
...
def subplots():
    ...
    # Produk A
    axs[0].plot(months, product_A_sales, label='Product A',
                color='blue', marker='o')
    ...
    # Produk B
    axs[1].plot(months, product_B_sales, label='Product B',
                color='red', marker='x')
